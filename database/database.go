...
type Database interface {
	...
	// Election
	CreateElection(integratorAPIKey, orgEthAddress, processID, encryptedMetadataKey []byte, title string, proofType types.ProofType, startDate, endDate time.Time, censusID uuid.NullUUID, startBlock, endBlock int, confidential, hiddenResults bool) (int, error)
